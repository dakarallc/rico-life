...
<div class="lp">
	<!-- SP -->
	<img src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp1.png" alt="RicoLifeのzeh" data-src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp1.png" class="ls-is-cached sp" loading="lazy">

	<!-- PC -->
	<img src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp-pc1.png" alt="RicoLifeのzeh" data-src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp-pc1.png" class="ls-is-cached pc" loading="lazy">

	<img src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp2.png" alt="RicoLifeの平屋" data-src="<?php echo rico_theme_url(); ?>/assets/img/lp/zeh-lp2.png" class="ls-is-cached sp" loading="lazy">
 ...
 if ($the_query->have_posts()): ?>
	...
	50,
       ...
       endwhile; ?>
		...
		<img src="<?php echo rico_theme_url(); ?>/assets/img/lp/lp3.png" alt="RicoLifeの平屋" data-src="<?php echo rico_theme_url(); ?>/assets/img/lp/lp3.png" class="ls-is-cached lazyloaded sp">

		<img src="<?php echo rico_theme_url(); ?>/assets/img/lp/lp4.png" alt="RicoLifeの平屋" data-src="<?php echo rico_theme_url(); ?>/assets/img/lp/lp4.png" class="ls-is-cached lazyloaded sp">
