...
<div class="specPerformance">
	...
	<section class="specHead">
		<div class="inner">
			...
			<h3 class="specHead__title">住宅性能</h3>
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						窓ひとつで、暮らしは変わります。<br>
						外の暑さ寒さをしっかり遮り、室内の<br class="show--sp">
						心地よさを、静かに守る為、トリプルガラス<br class="show--sp">
						構造を採用しております。
					</p>
				</div>
			</div>
		...
		<div class="inner">
     	...
     	"[theme_url]",
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						毎日の"いってきます""ただいま"を支える<br class="show--sp">
						玄関ドアだからこそ、扉そのものに、<br class="show--sp">
						もっと心地よさと安心を兼ね備えた、<br class="show--sp">
						ジエスタ2×FamiLockを採用しています。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						断熱性能の決め手は気密性と充填性です。<br>
						吹付け断熱のMOCOフォームは、隅々まで<br class="show--sp">
						しっかり充填して高い気密効果を発揮します。
					</p>
				</div>
			</div>
