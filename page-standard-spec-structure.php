			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						建物の壁内部に使用される耐力面材は、<br class="show--sp">
						住まいの強度に関わる重要な構造要素。<br>
						ノボパンを採用することで、柱や梁だけでなく、<br class="show--sp">
						面全体で力を受け止め、耐震性を高めます。<br>
						構造強度と施工性を兼ね備えた、安心を<br class="show--sp">
						支える下地材です。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						耐震等級3は、住宅性能表示制度における<br class="show--sp">
						最高等級の耐震性能。<br>
						消防署や警察署などの防災拠点と同等<br class="show--sp">
						レベルの耐震性能が基準とされています。<br>
						万が一の大地震にも備える、安心の指標です。
					</p>
				</div>
			</div>
		</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						基礎は建物の荷重を地盤へ伝える重要な<br class="show--sp">
						構造部分。<br>
						ベタ基礎は、建物の底面全体を鉄筋コンク<br class="show--sp">
						リートで覆い、建物を面で支える基礎構造です。<br>
						荷重を地盤に均等に伝えることで、不同沈下<br class="show--sp">
						のリスクを抑えます。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						柱や梁の接合部には、仕口加工に頼らず、<br class="show--sp">
						専用の金物で緊結するピン工法を採用。<br>
						木材の断面欠損を抑えながら、安定した<br class="show--sp">
						構造強度を確保し、施工精度のばらつきを<br class="show--sp">
						軽減します。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						外壁は、雨や紫外線などの外部環境から<br class="show--sp">
						住まいを守る大切な部分。<br>
						高耐候塗膜を備えたFuge プラチナコート30<br class="show--sp">
						を採用し、耐久性と美しい外観を長く保ちます。
					</p>
				</div>
			</div>
