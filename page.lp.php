...
<div class="lp">
	<img src="<?php echo do_shortcode('[theme_url]'); ?>/assets/img/lp/lp1.png" alt="いえとち本舗の平屋" data-src="<?php echo do_shortcode('[theme_url]'); ?>/assets/img/lp/lp1.png" class="ls-is-cached lazyloaded">

	<!-- youtube動画ができるまでこコメントアウト -->
	<!-- 
	<div class="youtube-video-container">
		<iframe width="560" height="315" src="https://www.youtube.com/embed/YOUR_VIDEO_ID" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div> -->

	<img src="<?php echo do_shortcode('[theme_url]'); ?>/assets/img/lp/lp2.png" alt="いえとち本舗の平屋" data-src="<?php echo do_shortcode('[theme_url]'); ?>/assets/img/lp/lp2.png" class="ls-is-cached lazyloaded">
