	...
	<section class="specHead">
		<div class="inner">
			...
			<div class="costCompare">
				<div class="costCompare__numbers">
				...
				<div class="costCompare__body">
					<p>
						電気代は40年で<br class="show--sp">
						<span class="highlight-yellow">15,230,000円</span>支払う可能性があります。
					</p>
					<p>
						ソーラー＆蓄電池が標準装備のRico Life.は<br class="show--sp">
