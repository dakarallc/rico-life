	...
	<section class="specHead">
		<div class="inner">
			...
			<div class="specHead__lead">
				<p>
					キッチンや浴室、洗面、トイレなど、毎日の暮らしの中で自然と使われるもの。料理や身支度、入浴や掃除といった日々の生活の場面に関わる設備です。
				</p>
				<p>
					採用している内容や特徴を、ひとつずつご覧いただけます。
				</p>
			</div>
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						キッチンは、毎日の家事の中心になる場所。使いやすさとお手入れのしやすさを考えたシステムキッチンを採用しています。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						朝の身支度や帰宅後の手洗いなど、一日に何度も使う洗面スペース。使いやすさと清潔感を大切にしながら、空間に合わせて選べる洗面化粧台を採用しています。
					</p>
				</div>
			</div>
		...
		<div class="inner">
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						毎日使う場所だからこそ、清潔さと使いやすさを重視したトイレを採用しています。
					</p>
				</div>
			</div>
