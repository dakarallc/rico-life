...
<div class="floating">
  <div class="floating__inner">
    ...
    <!-- <div class="floating__item">
      <a href="<?php echo do_shortcode("[home_url]"); ?>request" onClick="ga('send', 'event', 'request', 'tap','reservation')">
        <i class="fa-solid fa-book-open fa-xl"></i>
        <p class="floating__text">資料請求</p>
      </a>
    </div> -->
    <div class="floating__item">
      <a href="<?php echo do_shortcode("[home_url]"); ?>contact" onClick="ga('send', 'event', 'raizyou', 'tap','reservation')">
