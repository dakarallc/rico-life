<?php
/*
Template Name: 標準仕様 - 内装建材
*/
?>
<?php get_header(); ?>

<main class="specInterior">
	...
	<section class="specHead">
		<div class="inner">
			<div class="ttlWrap">
				<h2 class="section-ttl">Interior
					<span>商品概要</span>
				</h2>
			</div>
			<h1 class="specHead__title">内装建材</h1>

			<div class="specHead__lead">
				<p>
					建具や床材、壁紙など、住まいの<br class="show--sp">
					印象を左右する内装建材。
				</p>
				<p>
					素材や色、質感の違いによって、<br class="show--sp">
					空間の雰囲気や居心地が変わる、<br class="show--sp">
					多彩なラインナップを採用しています。
				</p>
			</div>
	...
	<!-- Interior door -->
	<section id="interior-door" class="specDetail">
		<div class="inner">
			<div class="specDetail__titleWrap">
				<h2 class="specDetail__title">Interior door</h2>
				<p class="specDetail__subtitle">室内ドア [LIXIL ラシッサS]</p>
			</div>
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						各部屋をつなぐ室内ドアは、空間の印象にも<br class="show--sp">
						関わる要素。<br>
						ラシッサSは、床材や壁紙と自然に調和する<br class="show--sp">
						よう住まい全体の統一感に配慮しています。
					</p>
				</div>
			</div>
			...
			<ul class="specFeature">
				<li class="specFeature__item">
					...
					<div class="specFeature__body">
						...
						<p class="specFeature__text">毎日使う室内ドアだからこそ、日常の動作が自然に行える使い心地のよい設計です。</p>
					</div>
				</li>
				<li class="specFeature__item">
					<div class="specFeature__img">
					...
					<div class="specFeature__body">
						...
						<p class="specFeature__text">傷や汚れに配慮した仕様で、日常の使用でも美しさを保ちやすい設計となっております。</p>
					</div>
				</li>
				<li class="specFeature__item">
					<div class="specFeature__img">
					...
					<div class="specFeature__body">
						...
						<p class="specFeature__text">空間の雰囲気に合わせて、木目やカラーなど多彩なデザインから選択可能です。</p>
					</div>
				</li>
			</ul>
			...
			<div class="specColor">
				...
				<p class="specColor__note">※1：印刷のため実際の商品と色味が異なる場合がございます。</p>
			</div>
		</div>
	</section>

	<!-- Flooring -->
	<section id="flooring" class="specDetail">
		<div class="inner">
			<div class="specDetail__titleWrap">
				<h2 class="specDetail__title">Flooring</h2>
				<p class="specDetail__subtitle">フローリング [LIXIL]</p>
			</div>
			...
			<div class="specDetail__hero">
				...
				<div class="specDetail__heroBody">
					...
					<p class="specDetail__desc">
						床は、住まいの中でも面積が大きく、<br class="show--sp">
						空間の印象を左右する大切な部分。<br>
						シートフローリングでありながら、天然木の<br class="show--sp">
						表情や質感を再現した床材を採用しています。
					</p>
				</div>
			</div>
			...
			<ul class="specFeature">
				<li class="specFeature__item">
					...
					<div class="specFeature__body">
						...
						<p class="specFeature__text">シートフローリングでありながら、独自の技術により、天然木が持つ豊かな表情を再現。</p>
					</div>
				</li>
				<li class="specFeature__item">
					<div class="specFeature__img">
					...
					<div class="specFeature__body">
						...
						<p class="specFeature__text">建築廃材などを再利用した「アースボード」を基材に採用。環境にも配慮した床材です。</p>
					</div>
				</li>
				<li class="specFeature__item">
					<div class="specFeature__img">
					...
					<div class="specFeature__body">
						<h4 class="specFeature__title">豊富なカラーバリエーション</h4>
						<p class="specFeature__text">空間の雰囲気に合わせて、多彩なデザインから選択可能です。</p>
					</div>
				</li>
			</ul>
